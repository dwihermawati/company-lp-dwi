    ...
    <>
      ...
      >
        ...
        >
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    activeSection === nav.href.replace('#', '') &&
                      'text-neutral-25 hover:text-primary-300 font-bold transition-all duration-300'
                  )}
                >
                  {nav.label}
                </Link>
          ...
          <Button
            className='hover:shadow-blue-glow mr-5 hidden h-10 w-40 lg:flex'
          ...
          <Sheet>
            ...
            <SheetContent>
              ...
              <SheetClose asChild>
                <Button
                  className='hover:shadow-blue-glow mt-4 w-full'
                  onClick={() => setIsDialogOpen(true)}
                >
                  Join Now
                </Button>
